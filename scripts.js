   ...
   if(parsedData[i]["country"]=="Tunisia")
                {
                    ...
                    var notifa ={
                      ...
                      title: 'Daily cases reminder',
                       message: 'les cas du jour dans tous tunisia :' + parsedData[i]["todayCases"] +' tous les cas : ' +parsedData[i]["cases"]
                    }
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  .then(data => {
    ...
    switch (elm.value) {
                        ...
                        break;
                        case "Beja":
                              cas = tunis["Beja, Tunisia"];
                        break;
                        case "Sidi Bouzid":
                              cas = tunis["Sidi Bouzid, Tunisia"];
                        break;
                        case "Kasserine":
                              cas = tunis["Kasserine, Tunisia"];
                        break;
                        case "Kef":
                              cas = tunis["Kef, Tunisia"];
                        break;
                        case "Zaghouane":
                              cas = tunis["Zaghouane, Tunisia"];
                        break;
